...
define([
	...
	function(declare, html, lang, on, query, _widgetBase, _TemplatedMixin, template) {
		/*jshint maxlen: 150*/
		return declare([_widgetBase, _TemplatedMixin], {
			...
			_onViewerMouseDown: function(evt) {
				...
				this._maxOffsetLeft = parseFloat(viewerContentStyle.width) - parseFloat(baseImageStyle.width);
				this._maxOffsetTop = parseFloat(viewerContentStyle.height) - parseFloat(baseImageStyle.height);
				this.inDrag = true;
